...
export default async function Landing() {
  ...
  return <main className="site-shell">
    ...
    <section className="landing-hero">
      <div className="landing-copy"><p className="eyebrow"><span className="dot" /> THE COURTSIDE WORKSPACE</p><h1>LESS SETUP.<br /><span>MORE GAME.</span></h1><p className="landing-description">Host your padel session from roster to results. Everything you need to keep the games moving, in one place.</p><Link className="button landing-cta" href="/sign-up">Start hosting <ArrowUpRightIcon /></Link></div>
