...
export default async function HomePage() {
  ...
  return <main className="site-shell workspace-page">
    ...
    <nav className="home-shortcuts" aria-label="Quick access"><Link href="/sessions"><span>01</span><strong>Sessions</strong><ArrowUpRightIcon /></Link><Link href="/history"><span>02</span><strong>History</strong><ArrowUpRightIcon /></Link><Link href={current[0] ? `/sessions/${current[0].id}/players` : "/sessions"}><span>03</span><strong>Players</strong><ArrowUpRightIcon /></Link><Link href="/settings"><span>04</span><strong>Settings</strong><ArrowUpRightIcon /></Link></nav>
