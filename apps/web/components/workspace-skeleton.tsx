...
function SessionHeading() {
  return <><div className="skeleton-breadcrumb"><Line width="200px" height={12} /></div><header className="session-workspace-head skeleton-session-head"><Line width="116px" height={11} /><Line width="min(70%, 440px)" height={70} /><nav className="session-tabs" aria-label="Loading session navigation">{[0, 1, 2, 3].map((item) => <Line key={item} width="68px" height={15} />)}</nav></header></>;
}
